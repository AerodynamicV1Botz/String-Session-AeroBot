...
@Client.on_message(filters.text & filters.incoming & filters.command("generate"))
...
async def generate_session(bot: Client, msg: Message, telethon=False, old_pyro: bool = False, is_bot: bool = False):
    ...
    text = f"**{ty.upper()} STRING SESSION** \n\n`{string_session}` \n\nGenerated by @String_Session_Generate_AeroBot"
    try:
        if not is_bot:
